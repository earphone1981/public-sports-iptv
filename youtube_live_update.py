...
# ---------- venue ids ----------
KEIRIN={
'函館':'keirin.hakodate','青森':'keirin.aomori','いわき平':'keirin.iwakitaira','弥彦':'keirin.yahiko','前橋':'keirin.maebashi','取手':'keirin.toride','宇都宮':'keirin.utsunomiya','大宮':'keirin.omiya','西武園':'keirin.seibuen','京王閣':'keirin.keiogatsu','立川':'keirin.tachikawa','松戸':'keirin.matsudo','川崎':'keirin.kawasaki','平塚':'keirin.hiratsuka','小田原':'keirin.odawara','伊東':'keirin.ito','伊東温泉':'keirin.ito','静岡':'keirin.shizuoka','名古屋':'keirin.nagoya','岐阜':'keirin.gifu','大垣':'keirin.ogaki','豊橋':'keirin.toyohashi','松阪':'keirin.matsusaka','四日市':'keirin.yokkaichi','富山':'keirin.toyama','福井':'keirin.fukui','奈良':'keirin.nara','岸和田':'keirin.kishiwada','和歌山':'keirin.wakayama','玉野':'keirin.tamano','広島':'keirin.hiroshima','防府':'keirin.hofu','高松':'keirin.takamatsu','小松島':'keirin.komatsushima','高知':'keirin.kochi','松山':'keirin.matsuyama','小倉':'keirin.kokura','久留米':'keirin.kurume','武雄':'keirin.takeo','佐世保':'keirin.sasebo','別府':'keirin.beppu','熊本':'keirin.kumamoto'}
...
# fixed venue channels: only emitted when LIVE exists
FIXED=[
# keirin
('立川','https://www.youtube.com/@%E7%AB%8B%E5%B7%9D%E3%83%A9%E3%82%A4%E3%83%96%E4%B8%AD%E7%B6%99/live',KEIRIN['立川'],'競輪 YouTube LIVE'),
('前橋','https://www.youtube.com/@%E5%89%8D%E6%A9%8B%E7%AB%B6%E8%BC%AA%E5%A0%B4/live',KEIRIN['前橋'],'競輪 YouTube LIVE'),
('高知競輪','https://www.youtube.com/@%E9%AB%98%E7%9F%A5%E7%AB%B6%E8%BC%AA%E3%81%A1%E3%82%83%E3%82%93%E3%81%AD%E3%82%8B%E5%85%AC%E5%BC%8F/live',KEIRIN['高知'],'競輪 YouTube LIVE'),
...
# horse
('園田・姫路','https://www.youtube.com/@sonodahimejiweb/live','keiba.sonoda','地方競馬 YouTube LIVE'),('大井','https://www.youtube.com/@tckkeiba/live',HORSE['大井'],'地方競馬 YouTube LIVE'),('金沢','https://www.youtube.com/@%E9%87%91%E6%B2%A2%E7%AB%B6%E9%A6%AC%E5%85%AC%E5%BC%8F%E3%83%81%E3%83%A3%E3%83%B3%E3%83%8D%E3%83%AB/live',HORSE['金沢'],'地方競馬 YouTube LIVE'),('岩手競馬','https://www.youtube.com/@IwateKeibaITV/live','keiba.morioka','地方競馬 YouTube LIVE'),('門別','https://www.youtube.com/@live2820/live',HORSE['門別'],'地方競馬 YouTube LIVE'),('川崎競馬','https://www.youtube.com/@%E5%85%AC%E5%BC%8F%E5%B7%9D%E5%B4%8E%E7%AB%B6%E9%A6%AC/live',HORSE['川崎'],'地方競馬 YouTube LIVE'),('佐賀','https://www.youtube.com/@sagakeibaofficial/live',HORSE['佐賀'],'地方競馬 YouTube LIVE'),('笠松','https://www.youtube.com/@%E7%AC%A0%E6%9D%BE%E3%81%91%E3%81%84%E3%81%B0%E3%83%AC%E3%83%BC%E3%82%B9%E6%98%A0%E5%83%8F%E9%85%8D%E4%BF%A1%E3%83%81%E3%83%A3/live',HORSE['笠松'],'地方競馬 YouTube LIVE'),('船橋','https://www.youtube.com/@funabashi-keiba/live',HORSE['船橋'],'地方競馬 YouTube LIVE'),('浦和','https://www.youtube.com/@%E6%B5%A6%E5%92%8C%E7%AB%B6%E9%A6%AC%E5%85%AC%E5%BC%8F/live',HORSE['浦和'],'地方競馬 YouTube LIVE'),('ばんえい','https://www.youtube.com/@%E3%81%B0%E3%82%93%E3%81%88%E3%81%84%E5%8D%81%E5%8B%9D%E5%85%AC%E5%BC%8F/live',HORSE['ばんえい'],'地方競馬 YouTube LIVE'),('高知競馬','https://www.youtube.com/@KeibaOrJp/live',HORSE['高知'],'地方競馬 YouTube LIVE'),
]

# existing fixed non-racing lives
EXTRA_FIXED=[
('ナミビア','https://www.youtube.com/watch?v=ydYDqZQpim8','youtube.namibia.live','🇳🇦 ナミビア LIVE'),('松山市クリーンセンター','https://www.youtube.com/watch?v=C0gpM_qIIl0','youtube.matsuyama.clean','♻️ 松山市クリーンセンター LIVE'),('松山空港','https://www.youtube.com/watch?v=CFh9z-6IeEE','youtube.matsuyama.airport','✈️ 松山空港 LIVE'),('大阪環状線','https://www.youtube.com/watch?v=HYQHcAqNBms','youtube.osaka.loop.live','🚃 大阪環状線 LIVE'),('淡路島モンキーセンター','https://www.youtube.com/watch?v=lsxYH2XQQCg','youtube.awaji.monkey.live','🐒 淡路島モンキーセンター LIVE'),('柴犬なつとこどもたち','https://www.youtube.com/watch?v=AqhaZl0fRYY','youtube.shiba.natsu.live','🐕 柴犬なつとこどもたち LIVE'),('新冠・馬カメラ','https://www.youtube.com/watch?v=1NtYMzERRxs','youtube.niikappu.horse.live','🐴 コノド・馬の映るお天気カメラ'),]

# Cross-channel sources: may carry multiple simultaneous venues; title decides tvg-id.
CROSS=[
('華奈tube','https://www.youtube.com/@kana_tube/streams','競輪 YouTube LIVE'),('WINTICKET','https://www.youtube.com/@winticket0402/streams','公営競技 横断LIVE'),('レディースインフォメーション','https://www.youtube.com/@%E3%83%AC%E3%83%87%E3%82%A3%E3%83%BC%E3%82%B9%E3%82%A4%E3%83%B3%E3%83%95%E3%82%A9%E3%83%A1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3/streams','ボートレース 横断LIVE'),('オッズパーク','https://www.youtube.com/@oddsparkcorp/streams','公営競技 横断LIVE'),('楽天競馬','https://www.youtube.com/@rakutenkeiba/streams','地方競馬 横断LIVE'),('オートレース公式','https://www.youtube.com/@autofficial/streams','オートレース YouTube LIVE')]

# screenshot-requested general LIVE sources. Search each run so dated IDs may change.
SEARCHES=[
('松山市南クリーンセンター入口付近','ytsearch1:LIVE 松山市南クリーンセンター入口付近','youtube.matsuyama.south.clean','🏭 松山市南クリーンセンター入口付近 LIVE'),('FloRacing 24/7','ytsearch1:LIVE NOW FloRacing 24/7','youtube.floracing.live','🏁 FloRacing 24/7 LIVE'),('瀬戸大橋','ytsearch1:瀬戸大橋 ライブカメラ KBN','youtube.seto.bridge.live','🌉 瀬戸大橋 LIVE'),('京都駅','ytsearch1:Kyoto Station Live Cam JR京都駅 ライブカメラ','youtube.kyoto.station.live','🚉 京都駅 LIVE'),('松山市本町','ytsearch1:松山市本町 ライブカメラ 南海放送NEWS','youtube.matsuyama.honmachi.live','🏙 松山市本町 LIVE'),('白良浜','ytsearch1:白良浜 ライブカメラ Movie Shirahama-Town','youtube.shirahama.live','🏖 白良浜 LIVE'),('Katmai bears','ytsearch1:LIVE Katmai National Park explore.org','youtube.katmai.bears.live','🐻 Katmai National Park LIVE'),('Sea Otter','ytsearch1:Sea Otter Cam Vancouver Aquarium LIVE','youtube.seaotter.live','🦦 Sea Otter Cam LIVE'),('関西国際空港','ytsearch1:関西国際空港 KIX ライブカメラ LIVE','youtube.kix.live','✈️ 関西国際空港 LIVE'),('ウェザーニュース','ytsearch1:ライブ 最新天気ニュース ウェザーニュース 2026','youtube.weathernews.live','☀️ ウェザーニュース LIVE'),('高校野球','ytsearch1:高校野球 2026 夏 甲子園 LIVE','youtube.highschool.baseball.live','⚾ 高校野球 LIVE'),('能登鹿島駅','ytsearch1:能登鹿島駅周辺 ライブ 穴水町','youtube.noto.kashima.live','🚃 能登鹿島駅 LIVE'),('道後温泉','ytsearch1:道後温泉本館 ライブカメラ','youtube.dogo.live','♨️ 道後温泉本館 LIVE')]

def run(cmd,timeout=120):
    return subprocess.run(cmd,capture_output=True,text=True,timeout=timeout)

def ytdlp_url(source):
    cmd=['yt-dlp','--js-runtimes','node','--cookies',COOKIES,'--no-playlist','--match-filter','is_live','--no-warnings','-f','95/best[protocol^=m3u8]/best','-g',source]
    p=run(cmd)
...
def live_items(channel_streams):
    cmd=['yt-dlp','--cookies',COOKIES,'--flat-playlist','--dump-json','--playlist-end','30',channel_streams]
    p=run(cmd,180)
    out=[]
    for ln in p.stdout.splitlines():
        ...
        if j.get('live_status')=='is_live' or j.get('is_live'):
            vid=j.get('id'); title=j.get('title') or ''
            if vid: out.append((title,'https://www.youtube.com/watch?v='+vid))
    return out

def classify(title):
    # Priority exact track names. High知 is ambiguous; source/title context resolves by keywords.
    if any(x in title for x in ['競輪','KEIRIN','けいりん','FⅠ','FII','F1','F2']):
        for k,v in sorted(KEIRIN.items(),key=lambda x:-len(x[0])):
            if k in title:return v,'競輪 YouTube LIVE'
    if any(x in title for x in ['ボート','BOAT','ヴィーナス','オールレディース','クイーンズ','レディース']):
        for k,v in sorted(BOAT.items(),key=lambda x:-len(x[0])):
            if k in title:return v,'ボートレース YouTube LIVE'
    if any(x in title for x in ['競馬','KEIBA','ばんえい','門別','盛岡','水沢']):
        for k,v in sorted(HORSE.items(),key=lambda x:-len(x[0])):
            if k in title:return v,'地方競馬 YouTube LIVE'
    if any(x in title for x in ['オートレース','AUTORACE']):
        for k,v in AUTO.items():
            if k in title:return v,'オートレース YouTube LIVE'
    # fallback venue-only, avoid 高知 ambiguity unless hints absent
    for mp,grp in [(KEIRIN,'競輪 YouTube LIVE'),(BOAT,'ボートレース YouTube LIVE'),(HORSE,'地方競馬 YouTube LIVE'),(AUTO,'オートレース YouTube LIVE')]:
        for k,v in sorted(mp.items(),key=lambda x:-len(x[0])):
            if k in title and k!='高知': return v,grp
    return None,None

def extinf(tvg,name,group):
    return f'#EXTINF:-1 tvg-id="{tvg}" tvg-name="{name}" group-title="{group}",{name}'

entries=[]
# fixed venue channels
for label,source,tvg,group in FIXED:
    try:url=ytdlp_url(source)
    except Exception as e: print('ERR',label,e);url=None
    if url:
        entries.append((tvg,f'📺 {label} 公式YouTube LIVE',group,url));print('OK',label)

# cross channels: inspect every LIVE, then classify title
for provider,source,default_group in CROSS:
    try: items=live_items(source)
    except Exception as e: print('ERR CROSS',provider,e);items=[]
    for title,page in items:
        tvg,grp=classify(title)
        if not tvg:
            print('UNMAPPED',provider,title);continue
        try:url=ytdlp_url(page)
        except:url=None
        if url:
            entries.append((tvg,f'📺 {provider}｜{title}',grp or default_group,url));print('OK CROSS',provider,title)

# fixed other LIVE
for label,source,tvg,name in EXTRA_FIXED:
    try:url=ytdlp_url(source)
    except:url=None
    if url: entries.append((tvg,name,'その他LIVE',url))

# screenshot general live searches
for label,source,tvg,name in SEARCHES:
    try:url=ytdlp_url(source)
    except:url=None
    if url: entries.append((tvg,name,'その他LIVE',url));print('OK SEARCH',label)

# BOAT 24 official remains provided by the existing repository system; if current M3U has them they are preserved.
# Remove only previous generated dynamic block.
...
# Deduplicate exact (tvg,name,url)
seen=set(); clean=[]
for e in entries:
    key=(e[0],e[1],e[3])
...
block=['',start]
for tvg,name,group,url in clean:
    block += [f'## {group}',extinf(tvg,name,group),url,'']
block += [end,'']
M3U.write_text(text.rstrip()+"\n"+'\n'.join(block),encoding='utf-8')
print('DYNAMIC LIVE COUNT',len(clean))
